...
PGPASSWORD=${POSTGRES_DEFAULT_PASSWORD} psql -c "ALTER USER ${POSTGRES_DEFAULT_USER} WITH PASSWORD '${POSTGRES_DEFAULT_PASSWORD}';" -U communication ${POSTGRES_DEFAULT_USER} || true
PGPASSWORD=${POSTGRES_DEFAULT_PASSWORD} psql -c "ALTER ROLE ${POSTGRES_DEFAULT_USER} SET statement_timeout='${TIMEOUT:-3m}';" -U communication ${POSTGRES_DEFAULT_USER} || true
