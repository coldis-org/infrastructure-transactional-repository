...
do
	...
	do
		...
		do
			...
			GRANT
GRANT CONNECT, TEMPORARY ON DATABASE "personallending" TO "caio.oliveira";
GRANT
GRANT USAGE ON SCHEMA "public" TO "caio.oliveira";
GRANT SELECT ON loan_view IN SCHEMA "public" TO "caio.oliveira";
GRANT
GRANT SELECT ON ALL SEQUENCES IN SCHEMA "public" TO "caio.oliveira";
GRANT
GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA "public" TO "caio.oliveira";
